...
public record DadosDetalhamentoPontoDeColeta(Long id, String localizacao, String setor, ModeloMedidor modelo_medidor_id, String tipo, BigDecimal limite_vazao, AbreOuFecha estado) {
